...
INSERT INTO `artists` VALUES (1,'Leonardo da Vinci','Italyan Ronesans ustasi. Ressam, bilim insani ve mucit.',1452,'İtalyan'),(2,'Vincent van Gogh','Post-empresyonizmin öncüsü. Canli renkleri ve yogun firca darbeleriyle taninir.',1853,'Hollandalı'),(3,'Edvard Munch','Ekspresyonizmin öncüsü, varoluşsal kaygılariyla taninan Norvecli ressam.',1863,'Norveçli'),(4,'Raphael','Ronesansin uc büyük ustasindan biri; denge ve armoni sembolü.',1483,'İtalyan'),(5,'Michelangelo','Ronesansin dehasi; Sistine Sapeli tavani ve heykeltrasligiyla ünlü.',1475,'İtalyan'),(6,'Salvador Dali','Sürrealizmin en taninan ismi; bilincdisi ve rüya imgelerini tuvallestirdi.',1904,'İspanyol'),(7,'Gustav Klimt','Viyana Sezesyon hareketinin önderi; altin yaprak kullanimiyla ünlü.',1862,'Avusturyalı'),(8,'Sandro Botticelli','Italyan Erken Ronesans ustasi; mitolojik sahneleriyle taninir.',1445,'İtalyan'),(9,'Osman Hamdi Bey','Osmanli döneminin önemli ressami ve müzeci.',1842,'Türk'),(10,'Zerhaki',NULL,NULL,NULL);
...
INSERT INTO `categories` VALUES (1,'Rönesans'),(2,'Post-Empresyonizm'),(3,'Ekspresyonizm'),(4,'Sürrealizm'),(5,'Sembolizm'),(6,'Türk Resim Sanatı'),(7,'Modern Sanat'),(8,'Pixelart');
...
INSERT INTO `coupons` VALUES (1,'SANAT10',10,1,1,'2025-12-31','Tüm eserlerde %10 indirim'),(2,'KTU2025',20,1,1,'2025-09-30','KTÜ öğrencilerine özel %20 indirim'),(3,'YENI15',15,1,1,'2025-06-30','Yeni üyelere özel %15 indirim');
